...
var challenges = [
    ...
    ,{options: {floorCount: 6, elevatorCount: 4, spawnRate: 1.7}, condition: requireUserCountWithinTime(100, 60)}
    ,{options: {floorCount: 6, elevatorCount: 2, spawnRate: 1.7}, condition: requireUserCountWithMaxWaitTime(40, 10)}
];
